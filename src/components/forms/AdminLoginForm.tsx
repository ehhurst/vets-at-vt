    ...
    <main className="min-h-screen flex items-center justify-center bg-[#14171a] px-4">
      ...
      >
        <form onSubmit={handleSubmit} className="w-[360px] sm:w-[420px] p-6 sm:p-8" noValidate>
          <h2 className="text-2xl font-vt-bold text-white/95">Admin Login</h2>
          <p className="mt-1 text-sm text-white/70">
            Sign in with your individual admin account to manage protected content.
          </p>
          ...
          <button
            ...
            className="mt-4 flex w-full items-center justify-center gap-3 rounded-md border border-white/10 bg-[#20252a] px-4 py-3 text-sm font-semibold text-white/90 transition-all duration-200 hover:-translate-y-0.5 hover:border-white/20 hover:bg-[#252b31] hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-70"
          >
            ...
            <span>
              {status === "submitting" ? "Connecting to Google..." : "Admin login with Google"}
            </span>
          </button>
