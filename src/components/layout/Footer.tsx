...
export default function Footer() {
  return (
    <footer className="w-full bg-white dark:bg-[#14171a] text-black/90 dark:text-white/90 shadow-md px-4 py-6 sm:px-6 lg:px-10 2xl:px-16">
        {/*start top row */}
        <div className="flex flex-col gap-4 border-b border-black/10 dark:border-white/10 pb-4 md:flex-row items-center md:justify-between">
            {/* footer nav links */}
            <FooterNavBar />
        ...
        <div className="pt-4">
            ...
            <div className="flex flex-col gap-3 md:flex-row items-center md:justify-between">
                ...
                <address className="not-italic text-sm text-black/90 dark:text-white/90">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
                        ...
                        <span className="hidden text-black/35 dark:text-white/35 sm:inline">|</span>

                        <span className="inline-flex items-center gap-2">
                            <IoIosMail aria-hidden="true" size={18} />
                            <a
                                href="mailto:veteran@vt.edu"
                                className="text-black/90 dark:text-white/90 underline-offset-2 hover:text-vt-impactOrange hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-vt-impactOrange focus-visible:ring-offset-2"
                                >
                                veteran@vt.edu
                                </a>
                        </span>
                ...
                {/* copyright info */}
                <p className="flex items-center gap-2 text-sm text-black/90 dark:text-white/90 md:justify-end">
